...
class MealCell: UICollectionViewCell {
  ...
  func addViews(){
    ...
    labelView.heightAnchor.constraint(equalToConstant: 70).isActive = true
    ...
    uiLabel.heightAnchor.constraint(equalToConstant: 70).isActive = true
    ...
    uiLabel.font = UIFont(name: uberFontString, size: 14.0) ?? UIFont.systemFont(ofSize: 16.0)
    uiLabel.textColor = .white
  }

  func setupUI(meal: MealItem, image: UIImage?) {
    uiImageView.image = image
    uiLabel.text = meal.strMeal
